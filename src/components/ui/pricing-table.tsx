  ...
  return (
    <div className="group/table overflow-hidden rounded-2xl border border-brand-100/80 bg-white/95 backdrop-blur-sm shadow-lg transition-all duration-300 hover:shadow-xl hover:border-brand-200">
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full divide-y divide-brand-50 text-xs sm:text-sm">
          <thead className="bg-brand-50/40 text-left text-[10px] sm:text-xs uppercase tracking-wider text-brand-700 font-semibold">
            <tr>
