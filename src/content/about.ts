export const aboutContent = {
  hero: {
    eyebrow: "About HPRC",
    title: "A home for Hyderabad’s equestrian heritage since 2005",
    description:
  ...
  leadership: [
    {
      ...
      role: "President",
      bio: "Serial entrepreneur and long-time polo player responsible for HPRC’s vision, strategy, and global collaborations. A Purdue alumnus, he actively promotes polo development across India.",
    },
    {
      name: "Kunwar Sai Vijender Singh",
      role: "Vice President",
      bio: "Sports enthusiast and martial artist with two decades of riding experience. As promoter of Prakruthi Infrastructures, he supports infrastructure growth and associate satisfaction.",
    },
    {
      name: "C. Sanjay Reddy",
      role: "Executive Committee",
      bio: "Industrialist with over 20 years in pharmaceuticals and real estate. Oversees operations, finance, and business affairs, bringing strategic insight to HPRC.",
    },
    {
      name: "Rupesh Y. Shah",
      role: "Treasurer",
      bio: "Manages club finances with a focus on sustainability and long-term growth for members and programmes.",
    },
    {
      name: "Syed Ahmed (Shahbaz)",
      role: "Joint Secretary",
      bio: "Educator, orator, and equestrian who champions inclusive education. Leads initiatives to revive polo in Hyderabad and mentor new riders.",
    },
    {
      name: "Sanjeev Kumar Agarwal",
      role: "Executive Member",
      bio: "Technologist and entrepreneur with global business experience. Founder of SYSTEL INC, guiding HPRC’s expansion and quality of service.",
    },
    {
      name: "Mohammed Nayeem Uddin",
      role: "Executive Member",
