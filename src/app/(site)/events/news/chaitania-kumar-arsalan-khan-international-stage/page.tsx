            ...
            <div className="relative z-10 p-8 md:p-16 lg:p-20">
              <div className="space-y-6 text-center">
                ...
                <p className="text-lg md:text-xl text-white/90 font-light max-w-3xl mx-auto leading-relaxed">
                  Representing India in Arena Polo
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="container">
        <div className="relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-brand-50/80 via-white to-brand-50/60 p-8 md:p-12 lg:p-16 border-2 border-brand-100/70 shadow-xl">
          <div className="space-y-8">
            <SectionHeading
              eyebrow="International Achievement"
              title="Chaitania Kumar and Arsalan Khan shine on the international stage"
              description="Two Hyderabadis - Chaitania R. Kumar and Arsalan Khan are part of the three-member Indian Arena Polo team which will participate in international competitions."
              align="center"
            />
