...
export default function TennisCampSportsVillageHPRCPage() {
  ...
  for (let i = 1; i <= 10; i++) {
    ...
    galleryImages.push({
      src: `/documents/gallery/news/tennis-camp-sports-village/${num}.jpg`,
      alt: `Tennis Camp by Sports Village at HPRC - Image ${i}`,
    });
  }
      ...
      <div className="space-y-16 pb-16">
          ...
          <div className="container pt-12">
            <div className="relative overflow-hidden rounded-[2.5rem] border-2 border-brand-200/50 shadow-[0_40px_80px_-20px_rgba(227,30,36,0.3)]">
              <div className="absolute inset-0">
                <Image
                  src="/documents/news/Sports-Village-HPRC-02.jpg"
                  alt="Tennis Camp by Sports Village at HPRC"
                  fill
              ...
              <div className="relative z-10 p-8 md:p-16 lg:p-20">
                <div className="space-y-6 text-center">
                  <h1 className="text-3xl md:text-5xl lg:text-6xl font-extrabold text-white font-display tracking-tight leading-tight">
                    Tennis Camp by Sports Village at HPRC
                  </h1>

                  <p className="text-lg md:text-xl text-white/90 font-light max-w-3xl mx-auto leading-relaxed">
                    Comprehensive tennis training and development program
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-brand-50/80 via-white to-brand-50/60 p-8 md:p-12 lg:p-16 border-2 border-brand-100/70 shadow-xl">
            <div className="space-y-8">
              <SectionHeading
                ...
                description="Sports Village conducted a comprehensive tennis camp at HPRC, providing training and development opportunities for tennis enthusiasts of all skill levels."
                align="center"
              />
        ...
        <section className="container">
          <SectionHeading
            ...
            title="Tennis Camp Photos"
            description="Browse through images from the Tennis Camp by Sports Village at HPRC."
            align="center"
          />
