...
export default function HprcInternationalArenaPoloChampionshipPage() {
  const { hero, overview, gallery } = hprcInternationalArenaPoloChampionship;
  ...
  const galleryImages = gallery.images.map((src, index) => ({
    src,
    alt: `HPRC International Arena Polo Championship - Image ${index + 1}`,
  }));
      ...
      <div className="space-y-16 pb-16">
            ...
            <div className="relative overflow-hidden rounded-[2.5rem] border-2 border-brand-200/50 shadow-[0_40px_80px_-20px_rgba(227,30,36,0.3)]">
              <div className="absolute inset-0">
                <Image
                  ...
                  alt="HPRC International Arena Polo Championship"
                  fill
        ...
        <section className="container">
          ...
          <p className="mt-6 text-center text-sm text-gray-600">
            Click on any image to view in full size ({gallery.images.length} images)
          </p>
        </section>
