...
import { hprcSportComplex } from "@/content/hprc-sport-complex";

export default function HprcSportComplexPage() {
  const { hero, overview, gallery } = hprcSportComplex;
  ...
  const galleryImages = gallery.images.map((src, index) => ({
    src,
    alt: `HPRC Sport Complex - Image ${index + 1}`,
  }));
          ...
          <div className="container pt-12">
            <div className="relative overflow-hidden rounded-[2.5rem] border-2 border-brand-200/50 shadow-[0_40px_80px_-20px_rgba(227,30,36,0.3)]">
              <div className="absolute inset-0">
                <Image
                  src="/documents/gallery/events/hprc-sport-complex/01.jpg"
                  alt="HPRC Sport Complex"
                  fill
