...
export default function NewslettersPage() {
  const [selectedNewsletter, setSelectedNewsletter] = useState<{ title: string; pdfUrl: string } | null>(null);
  ...
  const newsletters = [
    {
      ...
      description: "Comprehensive coverage of the National Equestrian Championship 2016, featuring competition results, highlights, and achievements."
    },
    {
      ...
      description: "The 4th edition of the Hyderabad Horse Show held in October 2015, showcasing equestrian excellence and competition highlights."
    },
    {
      ...
      description: "Monthly newsletter from May 2015 featuring club events, member achievements, and upcoming tournaments."
    },
    {
      ...
      description: "March 2015 newsletter covering club activities, equestrian events, and member updates."
    },
    {
      ...
      description: "January 2015 edition focusing on essential equestrian updates, training programs, and competition announcements."
    },
    {
      ...
      description: "The inaugural Hyderabad Horse Show held in December 2014, marking a significant milestone in HPRC's equestrian history."
    }
  ];
          ...
          <div className="bg-brand-50 rounded-2xl p-8">
            <div className="flex items-center gap-2 mb-2">
              <svg className="h-5 w-5 text-brand-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h7a2 2 0 01-2 2H6a2 2 0 01-2-2V6a2 2 0 012-2h7l5 5v7z" />
              </svg>
              <span className="text-sm font-semibold text-gray-700">
                All newsletters are archived from 2014-2016 with featured images and flipbook viewing.
              </span>
            </div>
            <p className="text-sm text-gray-600">
              Click on any newsletter card to open it in an interactive flipbook viewer. Navigate through pages, zoom, and download directly from the viewer.
            </p>
          </div>
        </section>
      </div>
