...
import { nationalQualifierOct2026 as equestrianChallenge2026 } from "@/content/oct-national-qualifier-2026";
...
// stays before the NQ camp opens (14 Oct) — the rider picks an arrival date.
// NQ_DATES and FULL_CAMP are flat fees for their fixed windows.
const STABLING_PACKAGES = {
  EARLY_ARRIVAL: { mode: "PER_DAY" as const, ratePerDay: 2500, from: "", to: "2026-10-14" },
  NQ_DATES: { mode: "FLAT" as const, total: 4000, from: "2026-10-14", to: "2026-10-16" },
  FULL_CAMP: { mode: "FLAT" as const, total: 10000, from: "2026-10-14", to: "2026-10-19" },
} as const;
...
function RegistrationForm() {
  ...
  React.useEffect(() => {
    ...
    try {
      const existing = JSON.parse(localStorage.getItem("oct-nq-2026-registrations") ?? "[]");
  ...
  // NQ has NO post-entries or spot entries — the form closes at 23:59 on 13 Oct 2026.
  const entryStatus = useMemo(() => {
    const now = new Date();
    const finalDeadline = new Date("2026-10-13T23:59:59+05:30");
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    try {
      ...
      localStorage.setItem("oct-nq-2026-registrations", JSON.stringify(existing));
    } catch {}
  ...
  return (
    <form 
      ...
      action="https://hprc.in/payment/octNq2026RequestHandler.php"
      method="POST" 
      ...
      <div className="text-center pt-2">
        {entryStatus === "CLOSED" ? (
          <div className="bg-red-50 border border-red-200 p-6 max-w-lg mx-auto">
            ...
            <p className="text-xs text-red-600">Entries closed at 23:59 hrs on Tuesday, 13 October 2026. No post-entries or spot entries are accepted.</p>
          </div>
        ) : (
          <>
            <button
            ...
            <p className="mt-3 text-xs text-gray-500">
              Entries close at 23:59 hrs on 13 October 2026. No post-entries or spot entries — please ensure all details are correct before submitting.
            </p>
          </>
        )}
      </div>
          ...
          <div className="relative overflow-hidden border-2 border-brand-200/50 shadow-[0_40px_80px_-20px_rgba(227,30,36,0.3)]">
            ...
            <div className="relative z-10 px-6 sm:px-12 md:px-20 pb-12 sm:pb-16 pt-20 sm:pt-24 text-center">
              ...
              <div className="inline-flex items-center gap-3 bg-gradient-to-r from-brand-500 to-brand-600 px-5 py-2.5 mb-6 shadow-xl shadow-brand-500/40">
                <Image
                  src="/events/oct-nq2026/efi_logo.png"
                ...
                <Image
                  src="/events/oct-nq2026/tsea-logo.jpeg"
              ...
              <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-white font-display tracking-tight leading-tight">
                National Qualifier
                <br />
                <span className="text-brand-300">(NQ) October 2026</span>
              </h1>
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-brand-50/80 via-white to-brand-50/60 p-8 sm:p-12 md:p-16 border border-brand-100 shadow-xl">
          ...
          <div className="mt-16 relative">
            ...
            <div className="relative flex flex-col items-center">
              ...
              <a
                href="/events/oct-nq2026/National_Qualifier_2026_Prospectus.pdf"
                target="_blank"
        ...
        <div className="relative overflow-hidden border-2 border-sky-200 shadow-2xl" style={{ background: "linear-gradient(135deg, #f0f7ff 0%, #e8f4fd 40%, #f5f0ff 70%, #eef5ff 100%)" }}>
          ...
          <div className="absolute inset-0 pointer-events-none overflow-hidden select-none" aria-hidden="true">
            ...
            <div className="absolute -top-8 -right-8 opacity-[0.045]">
              ...
              <img src="/events/oct-nq2026/efi_logo.png" alt="" className="w-72 h-72 object-contain" />
            </div>

            {/* TSEA logo watermark — bottom left */}
            <div className="absolute -bottom-10 -left-10 opacity-[0.04]">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/events/oct-nq2026/tsea-logo.jpeg" alt="" className="w-64 h-64 object-contain" />
            </div>
          ...
          <div className="relative p-6 sm:p-10 md:p-14">
            <div className="text-center mb-10">
              ...
              <p className="mt-3 text-sm text-gray-500 max-w-lg mx-auto">
                Fill in the form below to submit your official entry for the National Qualifier October 2026.
              </p>
              ...
              <div className="mt-8 max-w-3xl mx-auto">
                <div className="bg-brand-50 border-l-4 border-brand-500 p-4 text-left">
                  ...
                  <p className="text-sm font-bold text-brand-900">Tuesday, 13 October 2026 · 23:59 hrs</p>
                </div>
              </div>
