  ...
  return (
    <div className="bg-[#0c0c0c] text-white min-h-screen">
        ...
        <div className="container">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
            ...
            <p className="text-white/40 max-w-sm text-sm italic">
              A glimpse into the life of Arsalaan Khan, inside the arena and beyond.
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            <div className="md:col-span-8 aspect-video relative group overflow-hidden">
              <Image src="/images/gallery-6.png" alt="Gallery Large" fill className="object-cover group-hover:scale-110 transition-transform duration-[2000ms]" />
              <div className="absolute inset-0 bg-black/40 group-hover:bg-transparent transition-colors duration-500" />
            </div>
            <div className="md:col-span-4 aspect-square md:aspect-auto relative group overflow-hidden">
              <Image src="/images/arsalan-khan.png" alt="Gallery Portrait" fill className="object-cover group-hover:scale-110 transition-transform duration-[2000ms]" />
              <div className="absolute inset-0 bg-black/40 group-hover:bg-transparent transition-colors duration-500" />
            </div>
            <div className="md:col-span-4 aspect-square relative group overflow-hidden">
               <Image src="/images/gallery-5.jpg" alt="Gallery 3" fill className="object-cover group-hover:scale-110 transition-transform duration-[2000ms]" />
               <div className="absolute inset-0 bg-black/40 group-hover:bg-transparent transition-colors duration-500" />
            </div>
            <div className="md:col-span-8 aspect-[16/7] relative group overflow-hidden">
               <Image src="/images/chukker-2026.png" alt="Gallery 4" fill className="object-cover group-hover:scale-110 transition-transform duration-[2000ms]" />
               <div className="absolute inset-0 bg-black/40 group-hover:bg-transparent transition-colors duration-500" />
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-12 gap-16">
            ...
            <div className="lg:col-span-8 flex flex-col divide-y divide-white/10">
              {player.press.map((item, i) => (
                <Link key={i} href="#" className="group py-8 flex items-center justify-between hover:px-6 transition-all duration-500">
      ...
      <section className="py-32 relative overflow-hidden">
        <div className="container">
          <div className="bg-neutral-900 p-12 lg:p-20 relative">
             ...
             <div className="max-w-3xl">
                ...
                <h2 className="text-4xl xl:text-6xl font-extrabold font-display leading-[0.9] mb-10 tracking-tighter uppercase">Entrepreneurship &amp;<br/>Hospitality</h2>
                <p className="text-white/60 text-lg leading-relaxed font-light mb-8">
                  {player.bio.split("\n\n")[1]}
                </p>
                <div className="flex gap-4">
                  <Link href="/contact" className="bg-white text-black px-8 py-3 font-bold uppercase text-xs tracking-widest hover:bg-brand-500 hover:text-white transition-colors">Collaborate</Link>
                </div>
             </div>
          </div>
        </div>
