                ...
                <div className="flex flex-wrap items-center gap-4">
                  {featuredEvent.countries.map((country) => (
                    <div key={country.code} className="group relative">
                      <div className="bg-white/10 backdrop-blur-md border border-white/20  px-4 py-2 transition-all duration-300 hover:bg-white/20 hover:border-white/30 hover:scale-105">
            ...
            {homeContent.pillars.map((pillar, index) => {
              ...
              return (
                <Link
                  key={pillar.title}
                  href={pillar.href}
                  className="group relative overflow-hidden  bg-white shadow-xl border border-gray-100 transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 hover:border-brand-200 focus:outline-none focus:ring-2 focus:ring-brand-500/50 focus:ring-offset-4"
                >
                  {/* Elegant Image */}
      ...
      >
        ...
        <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-8 text-center relative z-10 max-w-5xl mx-auto">
          ...
          <Link
            ...
            className="mt-12 inline-flex items-center justify-center  bg-white px-10 py-4.5 sm:px-12 sm:py-5 text-base sm:text-lg font-bold text-brand-500 shadow-2xl transition-all duration-300 hover:bg-gray-50 hover:shadow-[0_35px_60px_-15px_rgba(255,255,255,0.3)] hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-white/50 focus:ring-offset-4 font-display tracking-wide"
          >
