...
import { badmintonContent } from "@/content/badminton";

export default function BadmintonPage() {
  const galleryImages = [
    {
      src: "/documents/gallery/badminton/bad1.jpeg",
      alt: "HPRC Badminton Court",
    },
    {
      src: "/documents/gallery/badminton/bad2.jpg",
      alt: "HPRC Badminton Facilities",
    },
  ];
  ...
  return (
    <div className="space-y-10 sm:space-y-16 pb-10 sm:pb-16">
      ...
      <div className="container pt-12">
        <PageHero
          eyebrow={badmintonContent.hero.eyebrow}
          title={badmintonContent.hero.title}
          description={badmintonContent.hero.description}
          actions={[
            { label: "Book a Session", href: "/contact", variant: "primary" },
            { label: "View All Facilities", href: "/sports-centre", variant: "outline" },
          ]}
          backgroundImage="/documents/gallery/badminton/bad.jpg"
        />
      </div>
      ...
      <section className="container space-y-6">
        <p className="text-sm text-gray-700 md:text-base leading-relaxed">
          Fill out the form below to enroll and avail our badminton court benefits.
        </p>
        <a
          href="#"
      ...
      <section className="container space-y-8">
        <SectionHeading
          eyebrow="Membership"
          title={badmintonContent.pricing.heading}
          ...
          align="left"
        />
        <PricingTable heading={badmintonContent.pricing.heading} rows={badmintonContent.pricing.rows} />
        <ul className="space-y-3 text-sm text-gray-600">
          {badmintonContent.pricing.notes.map((note) => (
      ...
      <section className="container space-y-8">
        <SectionHeading
          eyebrow="Gallery"
          title={badmintonContent.gallery.heading}
          description={badmintonContent.gallery.description}
          align="left"
        />
      ...
      <section className="container">
        <div className="rounded-3xl bg-gradient-to-r from-brand-600 to-brand-700 p-8 sm:p-12 text-center text-white shadow-xl">
          ...
          <p className="text-sm sm:text-base text-white/90 mb-6 max-w-2xl mx-auto">
            Contact us to book a court, enroll in coaching programs, or learn more about our badminton facilities.
          </p>
