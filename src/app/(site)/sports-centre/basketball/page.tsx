...
export default function BasketballPage() {
  const galleryImages = [
    {
      src: "/documents/gallery/basketball/ball1.jpeg",
      alt: "HPRC Basketball Court",
    },
    {
      src: "/documents/gallery/basketball/ball2.jpeg",
      alt: "HPRC Basketball Facilities",
    },
    {
      src: "/documents/gallery/basketball/ball3.jpeg",
      alt: "HPRC Basketball Court Area",
    },
    {
      src: "/documents/gallery/basketball/ball4.jpeg",
      alt: "HPRC Basketball Court View",
    },
    {
      src: "/documents/gallery/basketball/ball5.jpeg",
      alt: "HPRC Basketball Court",
    },
  ];
  ...
  return (
    <div className="space-y-10 sm:space-y-16 pb-10 sm:pb-16">
      ...
      <div className="container pt-12">
        <PageHero
          eyebrow={basketballContent.hero.eyebrow}
          title={basketballContent.hero.title}
          description={basketballContent.hero.description}
          actions={[
            { label: "Book a Session", href: "/contact", variant: "primary" },
            { label: "View All Facilities", href: "/sports-centre", variant: "outline" },
          ]}
          backgroundImage="/documents/gallery/basketball/Bg-Home-017.jpg"
        />
      </div>
      ...
      <section className="container space-y-6">
        <p className="text-sm text-gray-700 md:text-base leading-relaxed">
          Fill out the form below to enroll and avail our basketball court benefits.
        </p>
        <a
          href="#"
      ...
      <section className="container space-y-8">
        <SectionHeading
          eyebrow="Membership"
          title={basketballContent.pricing.heading}
      ...
      <section className="container space-y-8">
        <SectionHeading
          eyebrow="Gallery"
          title={basketballContent.gallery.heading}
          description={basketballContent.gallery.description}
          align="left"
        />
