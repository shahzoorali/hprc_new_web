...
import { squashContent } from "@/content/squash";

export default function SquashPage() {
  const galleryImages = [
    {
      src: "/documents/gallery/squash/squ1.jpeg",
      alt: "HPRC Squash Court",
    },
    {
      src: "/documents/gallery/squash/squ2.jpeg",
      alt: "HPRC Squash Facilities",
    },
    {
      src: "/documents/gallery/squash/squ3.jpeg",
      alt: "HPRC Squash Court Area",
    },
    {
      src: "/documents/gallery/squash/squ4.jpeg",
      alt: "HPRC Squash Court View",
    },
  ];
  ...
  return (
    <div className="space-y-10 sm:space-y-16 pb-10 sm:pb-16">
      ...
      <div className="container pt-12">
        <PageHero
          eyebrow={squashContent.hero.eyebrow}
          title={squashContent.hero.title}
          description={squashContent.hero.description}
          actions={[
            { label: "Book a Session", href: "/contact", variant: "primary" },
            { label: "View All Facilities", href: "/sports-centre", variant: "outline" },
          ]}
          backgroundImage="/documents/gallery/squash/Bg-Home-015.jpg"
        />
      </div>
      ...
      <section className="container space-y-6">
        <p className="text-sm text-gray-700 md:text-base leading-relaxed">
          Fill out the form below to enroll and avail our squash court benefits.
        </p>
        <a
          href="#"
      ...
      <section className="container space-y-8">
        <SectionHeading
          eyebrow="Membership"
          title={squashContent.pricing.heading}
          ...
          align="left"
        />
        <PricingTable heading={squashContent.pricing.heading} rows={squashContent.pricing.rows} />
        <ul className="space-y-3 text-sm text-gray-600">
          {squashContent.pricing.notes.map((note) => (
      ...
      <section className="container space-y-8">
        <SectionHeading
          eyebrow="Gallery"
          title={squashContent.gallery.heading}
          description={squashContent.gallery.description}
          align="left"
        />
      ...
      <section className="container">
        <div className="rounded-3xl bg-gradient-to-r from-brand-600 to-brand-700 p-8 sm:p-12 text-center text-white shadow-xl">
          ...
          <p className="text-sm sm:text-base text-white/90 mb-6 max-w-2xl mx-auto">
            Contact us to book a court, enroll in coaching programs, or learn more about our squash facilities.
          </p>
