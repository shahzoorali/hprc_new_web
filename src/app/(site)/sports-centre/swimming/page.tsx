...
export default function SwimmingPoolPage() {
  const galleryImages = [
    {
      src: "/documents/gallery/swimming/pool1.jpg",
      alt: "HPRC Swimming Pool",
    },
    {
      src: "/documents/gallery/swimming/pool2.jpg",
      alt: "HPRC Swimming Pool Facilities",
    },
    {
      src: "/documents/gallery/swimming/pool3.jpg",
      alt: "HPRC Swimming Pool Area",
    },
    {
      src: "/documents/gallery/swimming/pool4.jpg",
      alt: "HPRC Swimming Pool View",
    },
  ];
  ...
  return (
    <div className="space-y-10 sm:space-y-16 pb-10 sm:pb-16">
      ...
      <div className="container pt-12">
        <PageHero
          eyebrow={swimmingContent.hero.eyebrow}
          title={swimmingContent.hero.title}
          description={swimmingContent.hero.description}
          actions={[
            { label: "Book a Session", href: "/contact", variant: "primary" },
            { label: "View All Facilities", href: "/sports-centre", variant: "outline" },
          ]}
          backgroundImage="/documents/gallery/swimming/pool1m.jpg"
        />
      </div>
      ...
      <section className="container space-y-6">
        <p className="text-sm text-gray-700 md:text-base leading-relaxed">
          Fill out the form below to enroll and avail our swimming program benefits.
        </p>
        <a
          href="#"
      ...
      <section className="container space-y-8 sm:space-y-12">
        <SectionHeading
          ...
          description="Plan your visit according to our schedule. Ladies-only sessions available for your comfort."
          align="left"
        />
        <div className="grid gap-6 sm:gap-8 md:grid-cols-2">
          {swimmingContent.timings.map((timing, index) => {
            const isClosed = timing.label.toLowerCase().includes("closed");
            return (
              <div
                key={timing.label}
                className={`p-6 rounded-2xl border-2 transition-all duration-300 ${
                  isClosed
                    ...
                    : "border-brand-200 bg-gradient-to-br from-brand-50/30 to-white hover:border-brand-300 hover:shadow-lg"
                }`}
              >
                <h3
                  className={`text-lg font-semibold mb-2 ${
                    isClosed ? "text-red-700" : "text-brand-900"
                  }`}
                >
                  {timing.label}
                </h3>
                <p className={`text-sm ${isClosed ? "text-red-600" : "text-gray-700"}`}>
                  {timing.time}
                </p>
              </div>
            );
      ...
      <section className="container space-y-8">
        <SectionHeading
          eyebrow="Membership"
          title={swimmingContent.pricing.heading}
      ...
      <section className="container space-y-8">
        <SectionHeading
          eyebrow="Gallery"
          title={swimmingContent.gallery.heading}
          description={swimmingContent.gallery.description}
          align="left"
        />
