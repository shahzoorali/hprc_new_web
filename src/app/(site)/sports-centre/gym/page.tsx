...
export default function GymPage() {
  const galleryImages = [
    {
      src: "/documents/gallery/gym/g01.jpeg",
      alt: "HPRC Gym Facilities",
    },
    {
      src: "/documents/gallery/gym/g02.jpeg",
      alt: "HPRC Gym Equipment",
    },
    {
      src: "/documents/gallery/gym/g03.jpeg",
      alt: "HPRC Gym Area",
    },
    {
      src: "/documents/gallery/gym/g04.jpeg",
      alt: "HPRC Gym View",
    },
  ];
  ...
  return (
    <div className="space-y-10 sm:space-y-16 pb-10 sm:pb-16">
      ...
      <div className="container pt-12">
        <PageHero
          eyebrow={gymContent.hero.eyebrow}
          title={gymContent.hero.title}
          description={gymContent.hero.description}
          actions={[
            { label: "Book a Session", href: "/contact", variant: "primary" },
            { label: "View All Facilities", href: "/sports-centre", variant: "outline" },
          ]}
          backgroundImage="/documents/gallery/gym/Bg-Home-019.jpg"
        />
      </div>
      ...
      <section className="container space-y-6">
        <p className="text-sm text-gray-700 md:text-base leading-relaxed">
          Fill out the form below to enroll and avail our gym studio benefits.
        </p>
        <a
          href="#"
      ...
      <section className="container space-y-8">
        <SectionHeading
          eyebrow="Membership"
          title={gymContent.pricing.heading}
          ...
          align="left"
        />
        <PricingTable heading={gymContent.pricing.heading} rows={gymContent.pricing.rows} />
        <ul className="space-y-3 text-sm text-gray-600">
          {gymContent.pricing.notes.map((note) => (
      ...
      <section className="container space-y-8">
        <SectionHeading
          eyebrow="Gallery"
          title={gymContent.gallery.heading}
          description={gymContent.gallery.description}
          align="left"
        />
      ...
      <section className="container">
        <div className="rounded-3xl bg-gradient-to-r from-brand-600 to-brand-700 p-8 sm:p-12 text-center text-white shadow-xl">
          <h2 className="text-2xl sm:text-3xl font-bold mb-4">Ready to Get Fit?</h2>
          <p className="text-sm sm:text-base text-white/90 mb-6 max-w-2xl mx-auto">
            Contact us to book a session, enroll in coaching programs, or learn more about our gym
            facilities.
          </p>
