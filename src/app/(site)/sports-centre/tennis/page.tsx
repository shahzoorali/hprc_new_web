...
import { tennisContent } from "@/content/tennis";

export default function TennisPage() {
  const galleryImages = [
    {
      src: "/documents/gallery/tennis/001.jpeg",
      alt: "HPRC Tennis Court",
    },
    {
      src: "/documents/gallery/tennis/002.jpg",
      alt: "HPRC Tennis Facilities",
    },
    {
      src: "/documents/gallery/tennis/003.jpg",
      alt: "HPRC Tennis Court Area",
    },
    {
      src: "/documents/gallery/tennis/004.jpg",
      alt: "HPRC Tennis Court View",
    },
  ];
  ...
  return (
    <div className="space-y-10 sm:space-y-16 pb-10 sm:pb-16">
      ...
      <div className="container pt-12">
        <PageHero
          eyebrow={tennisContent.hero.eyebrow}
          title={tennisContent.hero.title}
          description={tennisContent.hero.description}
          actions={[
            { label: "Book a Session", href: "/contact", variant: "primary" },
            { label: "View All Facilities", href: "/sports-centre", variant: "outline" },
          ]}
          backgroundImage="/documents/gallery/tennis/TennisCourt01.jpg"
        />
      </div>
      ...
      <section className="container space-y-6">
        <p className="text-sm text-gray-700 md:text-base leading-relaxed">
          Fill out the form below to enroll and avail our tennis court benefits.
        </p>
        <a
          href="#"
      ...
      <section className="container space-y-8">
        <SectionHeading
          eyebrow="Membership"
          title={tennisContent.pricing.heading}
          ...
          align="left"
        />
        <PricingTable heading={tennisContent.pricing.heading} rows={tennisContent.pricing.rows} />
        <ul className="space-y-3 text-sm text-gray-600">
          {tennisContent.pricing.notes.map((note) => (
      ...
      <section className="container space-y-8">
        <SectionHeading
          eyebrow="Gallery"
          title={tennisContent.gallery.heading}
          description={tennisContent.gallery.description}
          align="left"
        />
      ...
      <section className="container">
        <div className="rounded-3xl bg-gradient-to-r from-brand-600 to-brand-700 p-8 sm:p-12 text-center text-white shadow-xl">
          ...
          <p className="text-sm sm:text-base text-white/90 mb-6 max-w-2xl mx-auto">
            Contact us to book a court, enroll in coaching programs, or learn more about our tennis facilities.
          </p>
