    ...
    <div className="space-y-24 pb-24">
      ...
      <section className="container space-y-16">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {aboutContent.facilities.map((facility, index) => {
            const facilityIcons = [
              <svg key="0" className="h-7 w-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-brand-50/50 via-white to-brand-50/40 py-24">
        ...
        <div className="container relative space-y-16">
          ...
          <div className="grid gap-10 lg:grid-cols-2">
            <div className="group relative overflow-hidden rounded-[3rem] border border-brand-100/70 bg-white/98 backdrop-blur-sm p-12 shadow-xl transition-all duration-700 hover:shadow-2xl hover:-translate-y-2 hover:border-brand-200">
              ...
              <div className="relative">
                ...
                {/* Elegant Typography */}
                <h3 className="text-3xl font-bold text-brand-900 mb-6 font-display tracking-tight">Mission</h3>
            ...
            <div className="group relative overflow-hidden rounded-[3rem] border border-brand-100/70 bg-white/98 backdrop-blur-sm p-12 shadow-xl transition-all duration-700 hover:shadow-2xl hover:-translate-y-2 hover:border-brand-200">
              ...
              <div className="relative">
                ...
                {/* Elegant Typography */}
                <h3 className="text-3xl font-bold text-brand-900 mb-6 font-display tracking-tight">Vision</h3>
                <p className="text-lg text-gray-700 leading-relaxed font-light">
                  {aboutContent.vision}
                </p>
              </div>
          ...
          <div className="mt-12">
            <h3 className="text-2xl font-bold text-brand-900 mb-12 text-center font-display tracking-tight">Our Core Values</h3>
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {aboutContent.values.map((value, index) => {
                const valueIcons = [
                  ...
                  <svg key="1" className="h-7 w-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v-1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                  </svg>,
                  <svg key="2" className="h-7 w-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                  </svg>,
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative">
                      ...
                      {/* Elegant Typography */}
                      <h4 className="text-xl font-bold text-brand-900 mb-4 font-display tracking-tight">{value.title}</h4>
