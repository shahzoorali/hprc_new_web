  ...
  return (
    <div className="space-y-24 pb-24">
      ...
      <div className="container -mt-12 sm:-mt-16 md:-mt-20 relative z-20">
        <div className="relative overflow-hidden rounded-[2rem] sm:rounded-[2.5rem] bg-gradient-to-r from-brand-900 via-brand-800 to-brand-900 shadow-2xl">
      ...
      <section className="container space-y-10 sm:space-y-16 pt-8 sm:pt-12">
        ...
        <div className="relative overflow-hidden rounded-[2rem] sm:rounded-[3.5rem] bg-gradient-to-br from-brand-50/70 via-white to-brand-50/50 p-6 sm:p-12 md:p-20 border border-brand-100/70 shadow-2xl">
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <div className="absolute top-0 right-0 w-60 h-60 sm:w-80 sm:h-80 bg-brand-500/5 rounded-full blur-[100px] sm:blur-[120px]"></div>
            <div className="absolute bottom-0 left-0 w-48 h-48 sm:w-64 sm:h-64 bg-brand-600/5 rounded-full blur-[80px] sm:blur-[100px]"></div>
          </div>

          <div className="relative grid gap-8 sm:gap-12 lg:grid-cols-2 lg:gap-20 items-center">
            <div className="space-y-4 sm:space-y-8">
              {aboutContent.overview.map((paragraph, idx) => (
                <p
                  key={paragraph}
                  className="text-base sm:text-lg md:text-xl text-gray-700 leading-relaxed font-light animate-fade-in-up"
            ...
            <div className="relative aspect-square rounded-[1.5rem] sm:rounded-[2.5rem] overflow-hidden shadow-2xl group">
              <img
              ...
              <div className="absolute bottom-4 sm:bottom-8 left-4 sm:left-8 right-4 sm:right-8">
                <p className="text-white text-[10px] sm:text-sm font-semibold uppercase tracking-wider mb-1 sm:mb-2">Since 2005</p>
                <p className="text-white text-sm sm:text-lg font-light">Nurturing Hyderabad's polo legacy</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="container space-y-10 sm:space-y-16">
        ...
        <div className="grid gap-4 sm:gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {aboutContent.facilities.slice(0, 8).map((facility, index) => (
            <div
              key={facility}
              className="group relative overflow-hidden rounded-[1.5rem] sm:rounded-[2rem] border border-brand-100/70 bg-white/98 backdrop-blur-sm p-5 sm:p-8 shadow-lg transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 hover:border-brand-200"
            >
              ...
              <div className="absolute right-0 top-0 h-20 w-20 sm:h-24 sm:w-24 rounded-bl-full bg-gradient-to-br from-brand-500/10 to-brand-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-700 group-hover:scale-150"></div>

              <div className="relative">
                <div className="mb-4 sm:mb-6 flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-brand-500/15 to-brand-500/5 text-brand-600 transition-all duration-500 group-hover:scale-110 group-hover:rotate-6 border border-brand-200/40 shadow-sm">
                  <svg className="h-6 w-6 sm:h-7 sm:w-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5 16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714 2.143L13 3z" />
                  </svg>
                </div>
                <p className="text-sm sm:text-base md:text-lg text-gray-700 leading-relaxed font-light">{facility}</p>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="rounded-[2rem] sm:rounded-[3rem] border border-brand-100/70 bg-gradient-to-br from-brand-50/50 via-white to-brand-50/30 p-6 sm:p-10 md:p-14 shadow-xl">
          <p className="text-[10px] sm:text-xs sm:text-sm font-semibold uppercase tracking-wider text-brand-600 mb-4 sm:mb-6 text-center">Additional Premium Amenities</p>
          <div className="grid gap-4 sm:gap-6 md:grid-cols-2">
            {aboutContent.facilities.slice(8).map((facility) => (
              <div key={facility} className="flex items-center gap-3 sm:gap-4 group">
                <div className="flex h-10 w-10 sm:h-12 sm:w-12 flex-shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-brand-500/12 to-brand-500/4 text-brand-600 transition-all duration-300 group-hover:scale-110">
                  <svg className="h-5 w-5 sm:h-6 sm:w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <p className="text-sm sm:text-base text-gray-700 group-hover:text-brand-800 transition-colors">{facility}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="container relative space-y-20">
          ...
          <div className="grid gap-6 sm:gap-8 lg:gap-12 grid-cols-1 lg:grid-cols-2">
            <div className="group relative overflow-hidden rounded-[2.5rem] sm:rounded-[3.5rem] border border-brand-100/70 bg-white/98 backdrop-blur-sm p-8 sm:p-14 shadow-2xl transition-all duration-700 hover:shadow-3xl hover:-translate-y-3 hover:border-brand-200">
              ...
              <div className="absolute right-0 top-0 h-40 w-40 sm:h-56 sm:w-56 rounded-bl-full bg-gradient-to-br from-brand-500/12 to-brand-500/5 transition-all duration-700 group-hover:scale-150 group-hover:from-brand-500/18"></div>

              <div className="relative">
                <div className="mb-6 sm:mb-10 flex h-20 w-20 sm:h-24 sm:w-24 items-center justify-center rounded-[2rem] sm:rounded-[2.5rem] bg-gradient-to-br from-brand-500/20 to-brand-500/8 text-brand-600 shadow-2xl transition-all duration-500 group-hover:scale-110 group-hover:rotate-12 border border-brand-200/50">
          ...
          <div>
            ...
            <div className="grid gap-6 sm:gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
              {aboutContent.values.map((value, index) => (
                <div
                  key={value.title}
                  className="group relative overflow-hidden rounded-[2rem] sm:rounded-[2.5rem] border border-brand-100/70 bg-white/98 backdrop-blur-sm p-6 sm:p-10 shadow-lg transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 hover:border-brand-200"
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-brand-500/4 via-transparent to-brand-500/6 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                  <div className="absolute right-0 top-0 h-24 w-24 sm:h-32 sm:w-32 rounded-bl-full bg-gradient-to-br from-brand-500/12 to-brand-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-700 group-hover:scale-150"></div>

                  <div className="relative">
                    <div className="mb-4 sm:mb-6 flex h-14 w-14 sm:h-16 sm:w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-brand-500/18 to-brand-500/8 text-brand-600 transition-all duration-500 group-hover:scale-110 group-hover:rotate-6 border border-brand-200/40 shadow-md">
        ...
        <div className="container relative">
          ...
          <div className="grid gap-6 sm:gap-8 md:grid-cols-2 lg:grid-cols-3">
            {aboutContent.leadership.slice(0, 3).map((leader) => (
              <div
                key={leader.name}
                className="group relative overflow-hidden rounded-[2rem] sm:rounded-[2.5rem] bg-white/10 backdrop-blur-md border border-white/10 p-6 sm:p-8 transition-all duration-500 hover:bg-white/15 hover:border-white/20 hover:-translate-y-2"
              >
                <div className="relative z-10">
                  <div className="mb-4 sm:mb-6 flex h-16 w-16 sm:h-20 sm:w-20 items-center justify-center rounded-full bg-gradient-to-br from-brand-500 to-brand-600 text-2xl sm:text-3xl font-bold text-white shadow-2xl">
          ...
          <div className="relative p-8 sm:p-12 md:p-20 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 rounded-full bg-white px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base font-bold text-brand-900 shadow-xl transition-all duration-300 hover:bg-brand-50 hover:scale-105 hover:shadow-2xl"
              >
              ...
              <Link
                href="/contact"
                className="inline-flex items-center justify-center gap-2 rounded-full border-2 border-white px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base font-bold text-white shadow-xl transition-all duration-300 hover:bg-white hover:text-brand-900 hover:scale-105"
              >
                Schedule a Visit
                <svg className="h-4 sm:h-5 w-4 sm:w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
