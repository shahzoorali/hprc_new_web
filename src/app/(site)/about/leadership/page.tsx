        ...
        <div className="container px-4 relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg sm:text-xl text-slate-300 leading-relaxed max-w-2xl mx-auto">
              A passionate executive team with global experience guides HPRC&apos;s growth across
              sport, hospitality, and community initiatives.
            </p>
          </div>
        </div>
      </section>
                    ...
                    <div className="absolute top-4 left-4">
                      <span
                        className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-bold ${
                          index === 0 ? "bg-amber-500 text-amber-950" : "bg-brand-500 text-white"
                        }`}
                      >
                        {index === 0 && (
        ...
        <div className="container px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-slate-300 text-lg mb-10 max-w-xl mx-auto">
              Become part of Hyderabad&apos;s premier equestrian and lifestyle club, led by a team
