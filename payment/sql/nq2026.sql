-- Schema for the National Qualifier (NQ) 2026.
-- Run once on the production MySQL server before go-live. Read/written by
-- nq2026RequestHandler.php / nq2026ResponseHandler.php. Stabling is shared with
-- the Equestrian Challenge via the camp2026 inventory ledger (file-based).

CREATE TABLE IF NOT EXISTS `nq2026` (
